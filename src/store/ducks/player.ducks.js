...
export default function player(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case Types.HANDLE_POSITION:
      return { ...state, positionShow: state.duration * action.payload };

    case Types.SET_POSITION:
      return {
        ...state,
        position: state.duration * action.payload,
        positionShow: null
      };
...
export const Creators = {
  ...
  handlePosition: payload => ({ type: Types.HANDLE_POSITION, payload }),
  setPosition: payload => ({ type: Types.SET_POSITION, payload }),
